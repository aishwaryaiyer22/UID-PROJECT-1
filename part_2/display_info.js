...
function getOfficialsInfoOnPage(response, page) {
	...
	i = index
	search_result_html +="<div class=row><div class=\"col-md-5\" style = width:200px;height=200px;><a href=#><img class=img-responsive src="+response["officials"][index]["photoUrl"]+"></a></div><div class=col-md-5><h4>Name: "+response["officials"][index]["name"]+"</h4>"+"<h4>Party: "+response["officials"][index]["party"]+" </h4><h4>Address: "+response["officials"][i]["address"][0]["line1"]+","+response["officials"][i]["address"][0]["line2"]+","+response["officials"][i]["address"][0]["city"]+","+response["officials"][i]["address"][0]["state"]+","+response["officials"][i]["address"][0]["zip"]+"</h4>";
